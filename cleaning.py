...
def extraction():
    ...
    df_1 = pd.read_csv("data/df_1.csv",index_col=False)
    df_2 = pd.read_csv("data/df_2.csv",index_col=False)
    df_3 = pd.read_csv("data/df_3.csv",index_col=False)
    df_4 = pd.read_csv("data/df_4.csv",index_col=False)
    df_5 = pd.read_csv("data/df_5.csv",index_col=False)
    df_6 = pd.read_csv("data/df_6.csv",index_col=False)
